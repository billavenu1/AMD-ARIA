...
class ContextBuilder:
    ...
    def __init__(self, **kwargs):
        ...
        self.source_inclusion_level: str = kwargs.get("source_inclusion_level", "full content")
    ...
    async def build(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.source_id:
                await self._add_source_context(self.source_id, self.source_inclusion_level)
