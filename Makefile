...
# Get version from pyproject.toml (Windows-friendly way)
...
start-all:
	...
	@start /B uv run run_api.py
	@python -c "import time; time.sleep(3)"
	@echo "⚙️ Starting background worker..."
	@start /B uv run --env-file .env surreal-commands-worker --import-modules commands
